...
import piolet12 from './piolet-12.jpg';
import piolet16 from './piolet-16.jpg';
import piolet22 from './piolet-22.jpg';
import piolet09 from './piolet-09.jpg';
import piolet06 from './piolet-06.jpg';
...
![River standing with the fully loaded Piolet against red sandstone cliffs in Moab](./piolet-21.jpg "The Piolet fully loaded in Moab")
...
![Rear three-quarter view of the Piolet showing the Campeur rack, drivetrain, and bag setup against Moab buttes](./piolet-10.jpg "Rear view showing the rack and drivetrain")
...
![The Piolet parked on a canyon overlook above the White Rim road with the Colorado River far below](./piolet-04.jpg "Canyon overlook on the White Rim")

<PhotoInline src={piolet06} alt="The Piolet laid on its side against a towering red sandstone wall" caption="Resting against the sandstone" text="Riding over that landscape gave me the same feeling of exploration and independence that made me fall in love with biking in the first place. The bike rolled smoothly beneath me, letting me take in the miles of redrock passing by, and brought me back at the end of a long day ready for the next ride." />
