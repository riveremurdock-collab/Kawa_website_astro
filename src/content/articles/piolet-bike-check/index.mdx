...
<Photo src={piolet22} alt="Close-up of the fork and headtube showing the pebble paint texture and Sinewave dynamo light" caption="Pebble paint texture and dynamo light detail" />
...
<Photo src={piolet16} alt="Close-up of the waxed canvas pannier with the leather framebag visible behind" />
...
<Photo src={piolet09} alt="Close-up of the custom leather framebag laced to the Piolet frame" caption="Custom leather framebag" />
...
<Photo src={piolet06} alt="The Piolet laid on its side against a towering red sandstone wall" caption="Resting against the sandstone" />
