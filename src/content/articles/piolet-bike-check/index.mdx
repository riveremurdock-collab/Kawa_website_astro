...
import piolet21 from './piolet-21.jpg';
import piolet10 from './piolet-10.jpg';
import piolet17 from './piolet-17.jpg';
import piolet04 from './piolet-04.jpg';
...
<Photo src={piolet21} alt="River standing with the fully loaded Piolet against red sandstone cliffs in Moab" title="The Piolet fully loaded in Moab" />
...
<Photo src={piolet12} alt="Full bike shot showing the custom muted green paint against red desert terrain" />
...
<Gallery images={[
  { src: piolet22, alt: "Close-up of the fork and headtube showing the pebble paint texture and Sinewave dynamo light" },
  { src: piolet10, alt: "Rear three-quarter view of the Piolet showing the Campeur rack, drivetrain, and bag setup against Moab buttes", title: "Rear view showing the rack and drivetrain" },
]} />
...
<Gallery images={[
  { src: piolet16, alt: "Close-up of the waxed canvas pannier with the leather framebag visible behind" },
  { src: piolet17, alt: "Both the waxed canvas pannier and leather framebag visible together on the bike against red desert scrub", title: "Pannier and framebag together" },
]} />
...
<Photo src={piolet09} alt="Close-up of the custom leather framebag laced to the Piolet frame" />
...
<Photo src={piolet04} alt="The Piolet parked on a canyon overlook above the White Rim road with the Colorado River far below" title="Canyon overlook on the White Rim" />
...
<Photo src={piolet06} alt="The Piolet laid on its side against a towering red sandstone wall" />
