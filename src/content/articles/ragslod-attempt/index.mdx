...
import ragslod5 from './ragslod-5.jpg';
import ragslod1 from './ragslod-1.jpg';
...
<Photo src={ragslod8} alt="Rivers Crosscheck loaded up for the ride" />
...
<Photo src={ragslod7} alt="Thomas biking on a dirt road outside Delle" />
...
<Photo src={ragslod5} alt="The causeway — 15 miles of sharp crushed rock" title="The causeway" />
...
<Gallery images={[
  { src: ragslod3, alt: "Blood-red pools and white salt flats on the lakebed seen from the causeway" },
  { src: ragslod4, alt: "Resting at the far end of the causeway" },
]} />
...
<Photo src={ragslod2} alt="The Hogup Mountains at dusk" />
...
<Photo src={ragslod1} alt="Last light over the Great Salt Lake" title="Sunset over the lake" />
