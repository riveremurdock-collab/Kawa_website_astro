...
<Gallery images={[
  { src: ragslod9, alt: "Thomas biking" },
  { src: ragslod8, alt: "Rivers Crosscheck loaded up for the ride" },
]} />
...
<Gallery images={[
  { src: ragslod7, alt: "Thomas biking on a dirt road outside Delle" },
  { src: ragslod5, alt: "The causeway — 15 miles of sharp crushed rock" },
]} />
